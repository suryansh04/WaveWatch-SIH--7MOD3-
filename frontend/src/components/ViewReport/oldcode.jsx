      ...
      {showModal && selectedReport && (
        <div className="view-reports-comp-modal-overlay" onClick={closeModal}>
          ...
          >
            ...
            <div
              className="view-reports-comp-modal-body"
              style={{ paddingTop: 0 }}
            >
              {/* Nearby Social Media Section */}
              <div className="view-reports-comp-social-media-section">
                <h3>
                  <Activity size={16} style={{ marginRight: 8 }} />
                  Nearby Social Media Posts (50km radius)
                </h3>
                ...
                {socialMediaLoading ? (
                  ...
                  <div className="view-reports-comp-no-social-posts">
                    ...
                    />
                    <p>
                      No social media posts found within 50km of this location
                    </p>
                  </div>
                ) : (
